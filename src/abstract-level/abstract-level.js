...
class AbstractLevel extends EventEmitter {
  ...
  async _put(_key, _value, _options) {}
  ...
  async _batch(_operations, _options) {}
  ...
  prefixKey(key, _keyFormat, _local) {
    return key;
  }
