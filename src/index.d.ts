 ...
 */
declare class LevelDB<KDefault = string, VDefault = string> extends AbstractLevel<
...
> {
  ...
  batch<K = KDefault, V = VDefault>(
    operations: Array<BatchOperation<typeof this, K, V>>,
  ...
  values<K = KDefault, V = VDefault>(
    options: ValueIteratorOptions<K, V>
  ): ValueIterator<typeof this, K, V>;
...
export interface DatabaseOptions<K, V>
  extends AbstractDatabaseOptions<K, V>,
    Omit<OpenOptions, 'passive'> {}

/**
 * Options for the {@link LevelDB.open} method.
 */
...
/**
 * Additional options for the {@link LevelDB.get} and {@link LevelDB.getMany}
 * methods.
 */
...
/**
 * Options for the {@link LevelDB.get} method.
 */
export interface GetOptions<K, V> extends AbstractGetOptions<K, V>, ReadOptions {}

/**
 * Options for the {@link LevelDB.getMany} method.
 */
export interface GetManyOptions<K, V> extends AbstractGetManyOptions<K, V>, ReadOptions {}

/**
 * Additional options for the {@link LevelDB.iterator}, {@link LevelDB.keys}
 * and {@link LevelDB.values} methods.
 */
...
/**
 * Additional options for the {@link LevelDB.put}, {@link LevelDB.del}
 * and {@link LevelDB.batch} methods.
 */
...
export class ChainedBatch<TDatabase, KDefault, VDefault> extends AbstractChainedBatch<
  TDatabase,
  KDefault,
  VDefault
> {
...
/**
 * Options for the {@link LevelDB.approximateSize} and
 * {@link LevelDB.compactRange} methods.
 */
