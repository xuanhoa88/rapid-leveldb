...
exports.setUp = function (test, testCommon) {
  test('iterator() range setup', async function () {
...
exports.range = function (test) {
  ...
  rangeTest(
    'lte=49.5 (midway) and reverse=true',
    {
      lte: '49.5',
      reverse: true,
    },
  ...
  rangeTest(
    'lt=49.5 (midway) and reverse=true',
    {
      lt: '49.5',
      reverse: true,
    },
  ...
  rangeTest(
    'gte=50.5 (midway) and reverse=true',
    {
      gte: '50.5',
      reverse: true,
    },
  ...
  rangeTest(
    'gt=50.5 (midway) and reverse=true',
    {
      gt: '50.5',
      reverse: true,
    },
  ...
  rangeTest(
    'gte=30 and lte=70 and gt=40 and lt=60',
    {
      gte: '30',
      lte: '70',
      gt: '40',
  ...
  rangeTest(
    'gte=30 and lte=70 and gt=20 and lt=80',
    {
      gte: '30',
      lte: '70',
      gt: '20',
  ...
  rangeTest(
    'gte=30 and lte=70 and reverse=true',
    {
      lte: '70',
      gte: '30',
      reverse: true,
  ...
  rangeTest(
    'gt=29 and lt=71 and reverse=true',
    {
      lt: '71',
      gt: '29',
      reverse: true,
  ...
  rangeTest(
    'limit=20 and lte=79 and reverse=true',
    {
      limit: 20,
      lte: '79',
      reverse: true,
  ...
  rangeTest(
    'lte after database end and reverse=true',
    {
      lte: '9a',
      reverse: true,
    },
  ...
  rangeTest(
    'lte and gte after database and reverse=true',
    {
      lte: '9b',
      gte: '9a',
      reverse: true,
  ...
  rangeTest(
    'lt and gt after database and reverse=true',
    {
      lt: '9b',
      gt: '9a',
      reverse: true,
...
exports.tearDown = function (test) {
  test('iterator() range teardown', async function () {
    return db.close();
  });
};
