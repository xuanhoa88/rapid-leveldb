...
exports.setUp = function (test, testCommon) {
  test('getMany() setup', async function () {
...
exports.getMany = function (test, testCommon) {
  ...
  test('simultaneous getMany()', async function (t) {
    ...
    for (let i = 0; i < 10; ++i) {
      promises.push(
        db.getMany(['hello']).then(function (values) {
          t.same(values, ['world']);
        })
      );
    }
    ...
    for (let i = 0; i < 10; ++i) {
      promises.push(
        db.getMany(['non-existent']).then(function (values) {
...
exports.tearDown = function (test) {
  test('getMany() teardown', async function () {
    return db.close();
  });
};
