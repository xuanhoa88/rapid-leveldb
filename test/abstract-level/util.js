...
for (const Ctor of [MinimalIterator, MinimalKeyIterator, MinimalValueIterator]) {
  const mapEntry =
    Ctor === MinimalIterator ? e => e.slice() : Ctor === MinimalKeyIterator ? e => e[0] : e => e[1];
  ...
  Ctor.prototype._seek = function (target) {
    this[kPosition] = this[kEntries].length;
