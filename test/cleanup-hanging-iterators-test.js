...
makeTest('multiple likely-closed iterators', async function (db) {
...
makeTest('multiple non-closed iterators', async function (db) {
...
global.gc &&
  makeTest('multiple non-closed iterators with forced gc', async function (db) {
...
makeTest('closing iterators', async function (db) {
  return new Promise((resolve, reject) => {
...
makeTest('recursive next', async function (db) {
...
makeTest('recursive next (random)', async function (db) {
